...
\begin{enumerate}
	...
	\item Prepare a stock solution (\qty{0.8}{\mL} of \qty{\sim500}{\milli\Molar}) of cyt \emph{c} (CAS 9007-43-6) in \ch{KP_{\emph{i}}} (\( \varepsilon_{410} \) for cyt \emph{c} in this solution is \qty{\sim105000}{\per\Molar\per\cm}, \( \varepsilon_{530} \) is \qty{11200}{\per\Molar\per\cm}).
...
\begin{enumerate}
	...
	Compare the distance between Trp-59 and the heme group for the fully folded protein (\qty{0.0}{\Molar} \iupac{urea}) with distances obtained from the known crystal structure (\href{https://www.rcsb.org/structure/1hrc}{PDB: 1HRC}). 
