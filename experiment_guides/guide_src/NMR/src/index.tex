...
Comparison of \cref{eq:slow_exch_peak} to the exact function shows that the linewidth of the line at \( \nu_{\ch{A}} \) is
\begin{equation}
...
\begin{enumerate}
	\item Prepare a \qty{10}{vol\percent} solution of \ch{DMA} and deuterated solvent (\ch{DMSO-d6}, \ch{DMA-d9}, or \ch{pyridine-d5}) in  a \SIrange{1.5}{2.0}{\mL} microfuge tube.
...
\begin{enumerate}
	...
	Mark any solvent peaks with an asterisk (*). 
	If splitting patterns deviate from your expectations, discuss possible reasons for the deviation. 
