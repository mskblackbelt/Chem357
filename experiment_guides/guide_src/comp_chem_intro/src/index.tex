%TODO 
% - In Problem II: change wfn.property to wfn.variable @done
% - In Problem II: Move reference to spin, multiplicity to Problem III @done
% - In Problem II: Introduce np.arange(), slightly more info on np.argmin(), np.min() @done
