...
eq:k_obs,eq:rateconst1,eq:rateconst2,eq:rateapprox}).\sidenote[][-14\baselineskip]{
...
\begin{equation}
	\frac{I_0}{I} = \frac{1 + (4 \pi R D N_\mtext{A} / 1000) \tau_0 \ch{[Q]}}{Y} \, ,
...
\end{align*}
If \( Y = 1 \), \cref{eq:sv_step_rel} reduces to \cref{eq:sv_rel},\sidenote[][-3\baselineskip]{
