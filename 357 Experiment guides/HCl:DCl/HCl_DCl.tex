...
Although considerable work is now being done in the far-infrared region (below \qty{400}{\wn}), the spectral range from \qtyrange{4000}{400}{\wn} has received the greatest attention because the vibrational frequencies of most molecules lie in this region. 
...
For studies concentrating on the region \qtyrange{4000}{500}{\wn}, \ch{NaCl} windows will suffice. 
...
I recommend scanning from \qtyrange{0.6}{4.5}{Å} in steps less than \qty{0.05}{Å}. 
