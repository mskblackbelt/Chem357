...
\begin{enumerate}
  ...
  \item Prepare a stock solution (\SI{50}{\mL}) of \SI{10.0}{\Molar} \iupac{urea} (CAS 75-13-6) in \ch{KP_{\emph{i}}}. 
  You should add the \iupac{urea} and phosphates to an empty graduated cylinder and add water up to \SI{50}{\mL}. 
  ...
  You should have \num{21} samples in \num{21} plastic Eppendorf tubes.\todo[inline]{Reduce this number to \num{\sim10} samples?}
...
\begin{enumerate}
  ...
  Determination of the integrated areas can be done numerically as a sum or using the integration functions built in to SciPy.\sidenote[][-4\baselineskip]{Additional pertinent information for this system: 
  \begin{gather}
    \kappa^2 = 2/3 \, ,\\
    n = 1.4 \, ,\\
    \Phi_\mtext{D} = 0.13
...
\subsection{Part C: Calculation of Intramolecular Distances for Unfolded Structures} % (fold)
...
% subsection part_c_calculation_of_intramolecular_distances_for_unfolded_structures (end)
