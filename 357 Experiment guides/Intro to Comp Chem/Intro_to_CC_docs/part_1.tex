...
\begin{enumerate}
  ...
  There, create a test directory (\bashinline{mkdir "dir-name"}) with a name of your choosing. 
...
In the script, on the line that says \Verb{for m in METHODS}, replace \Verb{METHODS} with the following list of density functionals:\sidenote{Edit the script file with the built-in editor or with Vim in the terminal.} \\
