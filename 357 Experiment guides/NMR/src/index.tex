...
\begin{margintable}[-10\baselineskip]
	...
	\begin{tabular}{@{}cS@{}} 
		\toprule
		\bfseries Coupling & {\( \symbfit{J} \, (\si{\textbf{Hz}}) \)} \\
		\midrule 
		\addlinespace[1em]
...
\begin{enumerate}
	\item Prepare a \SI{10}{vol\percent} solution of \ch{DMA} and deuterated solvent (\ch{DMSO-d6}, \ch{DMA-d9}, or \ch{pyridine-d5}) in  a \SIrange{1.5}{2.0}{\mL} microfuge tube.
	...
	The blue plastic spinners are only rated for use up to \SI{70}{\celsius}. 
