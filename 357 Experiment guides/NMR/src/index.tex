...
\end{figure}
Due to the characteristic period of the NMR measurement, a large range of reaction rates relevant in the chemical laboratory is easily accessible (\SIrange{e-1}{e-5}{\Hz}).
...
There is also an intermediate temperature range over which the spectrumconsists of two significantly broadened overlapping lines (\cref{fig:lineshapes_b}).
...
\subsection{Slow and Intermediate Exchange} % (fold)
...
\subsection{Coalescence Temperature} % (fold)
