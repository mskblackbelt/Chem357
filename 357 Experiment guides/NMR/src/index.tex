...
\begin{enumerate}
	\item Prepare a \SI{10}{vol\percent} solution of \ch{DMA} and deuterated solvent (\ch{DMF-d7}, \ch{DMA-d9}, or \ch{pyridine-d5}) in  a \SIrange{1.5}{2.0}{\mL} microfuge tube.
