...
\renewcommandthesubsubsection{thesubsubsection.arabic{subsubsubsection}}
...
\renewcommand\subsubsection{\@startsection{subsubsection}{3}{\z@}%
                                     ...
                                     {1.5ex \@plus .2ex}%
                                     {\normalfont\normalsize\itshape}}
\deftoclevel@subsubsection{3}
\defl@subsubsection{@dottedtocline{4}{7em}{4em}}
\makeatother
...
\begin{margintable}[-10\baselineskip]
	...
	\begin{tabular}{@{}cS@{}} 
		\toprule
		\bfseries Coupling & {\( \bm{J} \, (\unit{\textbf{Hz}}) \)} \\
		\midrule 
		\addlinespace[1em]
...
\begin{enumerate}
	\item Prepare a \qty{15}{vol\percent} solution of \ch{DMA} and \ch{DMSO-d6} in  a \qtyrange{1.5}{2.0}{\mL} microfuge tube. 
