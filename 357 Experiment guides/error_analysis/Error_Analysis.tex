...
Given a ruler with demarcations down to \qty{1}{\cm} and an object \qty{\sim8.3}{\cm} in length, three students might measure lengths of \qtylist{8.5;8.0;8.2}{\cm}. 
Naively, we might suggest that we would get better agreement by giving the students a ruler with \unit{\mm}-demarcations. 
But now, the students might measure \qtylist{8.35;8.30;8.28}{\cm} for the length… we still see disagreement in the value! 
...
Now our list of numbers is \qtylist{8.5;8.0;8.2;8.3;8.4;8.4}{\cm}. 
