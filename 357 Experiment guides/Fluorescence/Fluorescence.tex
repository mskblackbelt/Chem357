...
The units shown (and factor of 1000) pertain if \( C_0 \) is expressed in molarity (\si{\mol\per\liter}) and \( R \) and \( D \) are expressed in \si{\cm} and \si{\cm\squared \per \s}, respectively.\sidenote[][-5\baselineskip]{
