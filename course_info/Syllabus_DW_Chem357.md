...
left-foot: Chem 357, Spring 2026
---
...
: There is no textbook for this course. Relevant material will be posted on the course webpage. You _must_ read and complete a summary of the lab procedure in your notebook before you come to class. If you are interested in purchasing a physical laboratory book (entirely optional), many of our experiments will be modified from the standard physical chemistry laboratory lab manual by Garland, Nibler, and Shoemaker:  
_Experiments in Physical Chemistry,_ 7th Ed., 2003, McGraw-Hill, New York, NY.
...
: Course communication, lectures, help sessions, and announcements will be posted on the course page in [Microsoft Teams][ms-teams]. All students should have been invited to the team prior to the start of the semester. When logging in to Teams, you must use your _**CUNYfirst**_ login info. For example, if your MyHunter account is `jaylyn.teger14@myhunter.cuny.edu`, your Teams login should be `jaylyn.teger14@login.cuny.edu` with the same password. 
<!--Instructions on how to access the course website on Brightspace can be found on the [Hunter College Brightspace page][hunter-brightspace]. In addition to instructions for individual labs, announcements and additional resources will occasionally be posted on Brightspace. -->
...
- Toxic substances must be used only under the hood. You will be responsible for looking up and understanding the SDS of **all** chemicals used in the laboratory. 
...
<figure>
  <figcaption>Lab report grading rubric</figcaption>
...
: **Instrumentation used:** NMR spectrometer
...
: This lab will introduce you to rudimentary quantum calculations using the Psi4 computational chemistry software package.
: **Instrumentation used:** JupyterLab
...
Final Presentations
: Each group will be assigned a lab from the semester. Groups will create a detailed presentation related to the lab for their instructor and classmates. Presentations will be given at the end of the semester. More details will be given near the end of the semester.
